...
git clone https://github.com/ahmadnamed/ANIMUS.git
...
libpython-dev expat libexpat1-dev -y && cd $HOME && rm -rf superflux-bot && rm -rf .telegram-cli && git clone https://github.com/ahmadnamed/ANIMUS.git && cd ANIMUS && ./launch.sh install && ./launch.sh
~~~~~
